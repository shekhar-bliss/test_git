<?php
  ...
  // CHECK access permission for view igf
  if(in_array('view_any_igf', $pei_user_access_permission)) {
...
?>
                <th width="150px">Miscellaneous</th>
            </tr>
      <?php
      if($igf_server) {
...
?>
                <td><!-- PUBLIC IP --><?php echo $server['igf_server_public_ip'];?></td>
                <td><?php echo $server['igf_server_private_lan_ip'];?></td>
                <td><?php echo $server['igf_server_private_lan_sm'];?></td>
                <td><?php echo $server['igf_server_rac_ip'];?></td>
                <td><?php echo $server['igf_server_scan_ip'];?></td>
                <td><?php echo $server['igf_server_heartbeat_ip'];?></td>
                <td><?php echo $server['igf_server_cluster_ic_ip'];?></td>
                <td><?php echo $server['igf_server_oracle_vip'];?></td>

<?php
  }
?>
                <td><?php echo $server['igf_server_misc'];?></td>
            </tr>
      <?php
        }
      }
